    ...
    <>
      {props.imageViewerState && (
        <button
          ...
          className="  fixed z-10 inset-0 bg-gray-dark1  w-full h-screen flex  justify-center items-center  bg-opacity-40"
        >
          <div className="overflow-y-auto flex flex-col  w-full ssm:w-[800px] bg-white h-[780px] p-4 rounded-lg">
